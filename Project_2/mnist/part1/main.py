...
# print('softmax test_error_mod3_with_y_testmod3 =', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print(f'softmax test_error_18_pca = {test_error}')
...
print(f'softmax test_error_10_pca_cube = {test_error}')
